# Palo Alto Next-Generation Firewall Engineer - Pushing through Failures and Frustration #
On 4-28-2026, I was able to clear the [Palo Alto Next Generation Firewall Engineer Certification](https://www.paloaltonetworks.com/services/education/palo-alto-networks-ngfw-engineer). This was one of the most frustrating exam I have taken. It taught me how to push through frustration to accomplish a goal
...
6. INE Palo Alto Labs: This was more of an impulsive buy. I can't attest 100 percent that I needed it, but every little bit helps
...
Additionally, I built out my Google Doc notes by adding hyperlinks and referencing relevant Palo Alto TechDocs for each topic I found useful. Eventually, I had a fully built-out  exam datasheet–based notes, highlighting key concepts I needed to review prior to retake.
