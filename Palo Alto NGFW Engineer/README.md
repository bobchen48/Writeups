...
I started by watching the CBT Nuggets PCNSA and PCNSE courses by Keith Barker to absorb as much conceptual knowledge as I could. Because it was winter, I gave myself until Spring 2026 to prepare instead of relying on an aggressive approach to complete it within one to two months, as I did not want to go out during the winter to take any exams, and I wanted to take this one more slowly.
While I initially felt I was progressing at a decent pace and was able to complete the PCNSA course, I found the sheer volume of content in PCNSE (almost double that of PCNSA) to be too much. So, halfway through PCNSE, I decided to drop it in favor of learning from the official platform when January 2026 came around and I realized I needed to pick up the pace.
...
As I went through the exam, a steady sense of unease set in. Many questions left me uncertain—I could narrow them down to two choices, but it often came down to a 50–50 guess. In the end, I had failed.
